    ...
    def decorator(func: Callable):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                error_info = global_error_handler.handle_error(e, context, category, severity, recoverable)
...
def safe_execute(
    ...
    try:
        ...
        global_error_handler.handle_error(
            e, {"function": getattr(func, "__name__", "unknown")}, error_category, ErrorSeverity.LOW
        )
