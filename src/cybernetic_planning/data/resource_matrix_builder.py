...
class ResourceMatrixBuilder:
    ...
    def __init__(
        self, sector_mapper: Optional[SectorMapper] = None, data_collector: Optional[ResourceDataCollector] = None
    ):
        """
    ...
    def build_all_matrices(self, collected_data: Optional[Dict[str, Any]] = None, year: int = 2024) -> Dict[str, Any]:
        """
    ...
    def _build_constraints_vector(
        self, matrices: Dict[str, np.ndarray], collected_data: Dict[str, Any]
    ) -> Optional[np.ndarray]:
