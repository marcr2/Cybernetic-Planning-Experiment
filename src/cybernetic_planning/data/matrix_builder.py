...
class MatrixBuilder:
    ...
    def create_technology_matrix(self, data: Union[np.ndarray, List[List[float]], pd.DataFrame],
                               sectors: Optional[List[str]] = None,
                               name: str = "technology_matrix") -> np.ndarray:
        """
    ...
    def create_final_demand_vector(self, data: Union[np.ndarray, List[float], pd.Series],
                                 sectors: Optional[List[str]] = None,
                                 name: str = "final_demand") -> np.ndarray:
        """
    ...
    def create_labor_vector(self, data: Union[np.ndarray, List[float], pd.Series],
                          sectors: Optional[List[str]] = None,
                          name: str = "labor_input") -> np.ndarray:
        """
    ...
    def create_resource_matrix(self, data: Union[np.ndarray, List[List[float]], pd.DataFrame],
                             resources: Optional[List[str]] = None,
                             sectors: Optional[List[str]] = None,
                             name: str = "resource_matrix") -> np.ndarray:
        """
    ...
    def create_max_resources_vector(self, data: Union[np.ndarray, List[float], pd.Series],
                                  resources: Optional[List[str]] = None,
                                  name: str = "max_resources") -> np.ndarray:
        """
    ...
    def create_synthetic_data(self, n_sectors: int, 
                            technology_density: float = 0.3,
                            resource_count: int = 5,
                            name_prefix: str = "synthetic") -> Dict[str, Any]:
        """
    ...
    def _generate_synthetic_technology_matrix(self, n_sectors: int, density: float) -> np.ndarray:
        """Generate synthetic technology matrix."""
        ...
        for idx in indices:
            ...
            matrix[i, j] = np.random.uniform(0, 0.5)  # Input coefficients typically < 1
        
        # Ensure diagonal elements are small (self-consumption)
        np.fill_diagonal(matrix, np.random.uniform(0, 0.1, n_sectors))
        
        return matrix
    
    def _generate_synthetic_final_demand(self, n_sectors: int) -> np.ndarray:
        """Generate synthetic final demand vector."""
        return np.random.uniform(10, 100, n_sectors)
    
    def _generate_synthetic_labor_input(self, n_sectors: int) -> np.ndarray:
        """Generate synthetic labor input vector."""
        return np.random.uniform(0.1, 2.0, n_sectors)
    ...
    def export_to_dataframe(self, matrix_name: str, 
    ...
    def export_vector_to_series(self, vector_name: str, 
                              include_metadata: bool = True) -> pd.Series:
        """
