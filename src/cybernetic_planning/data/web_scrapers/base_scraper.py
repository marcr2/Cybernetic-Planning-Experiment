...
class BaseScraper(ABC):
    ...
    def __init__(self, 
        ...
        self.session.headers.update({
            'User-Agent': 'Cybernetic Planning System Data Collector 1.0'
        })
    ...
    def validate_data(self, data: Dict[str, Any], 
        ...
        valid_fields = sum(1 for v in data.values() 
                          if v is not None and 
                          (not isinstance(v, (list, str)) or len(v) > 0))
    ...
    def get_collection_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': (self.metadata['successful_requests'] / 
                           max(self.metadata['total_requests'], 1)),
