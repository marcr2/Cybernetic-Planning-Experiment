...
class InternationalDataCollector:
    ...
    def collect_country_data(self, country: str, year: int = 2024, 
...
class RussianScraper(BaseScraper):
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        ...
        return [
            {'id': 'russian_energy_data', 'name': 'Russian Energy Data', 'description': 'Energy statistics from Russian government'},
            {'id': 'russian_material_data', 'name': 'Russian Material Data', 'description': 'Material and mining data from Russian government'},
            {'id': 'russian_labor_data', 'name': 'Russian Labor Data', 'description': 'Labor statistics from Rosstat'},
            {'id': 'russian_environmental_data', 'name': 'Russian Environmental Data', 'description': 'Environmental data from Russian government'}
        ]
...
class EUScraper(BaseScraper):
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            {'id': 'eu_environmental_data', 'name': 'EU Environmental Data', 'description': 'Environmental data from EEA'}
        ]
...
class ChinaScraper(BaseScraper):
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            {'id': 'china_material_data', 'name': 'China Material Data', 'description': 'Material data from Chinese ministries'},
            {'id': 'china_labor_data', 'name': 'China Labor Data', 'description': 'Labor statistics from NBS'},
            {'id': 'china_environmental_data', 'name': 'China Environmental Data', 'description': 'Environmental data from MEE'}
        ]
...
class IndiaScraper(BaseScraper):
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        ...
        return [
            {'id': 'india_energy_data', 'name': 'India Energy Data', 'description': 'Energy statistics from Ministry of Power'},
            {'id': 'india_material_data', 'name': 'India Material Data', 'description': 'Material data from Ministry of Mines'},
            {'id': 'india_labor_data', 'name': 'India Labor Data', 'description': 'Labor statistics from Ministry of Labour'},
            {'id': 'india_environmental_data', 'name': 'India Environmental Data', 'description': 'Environmental data from MoEF'}
        ]
