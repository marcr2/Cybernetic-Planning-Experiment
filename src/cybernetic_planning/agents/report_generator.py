...
class ReportFormatter:
    ...
    def _generate_json_report(
        self, review: ComprehensiveReview, session: ReviewSession, options: Dict[str, Any]
    ) -> str:
...
"""
    ...
    def _generate_header_section(
        self, review: ComprehensiveReview, session: ReviewSession, format_type: str
    ) -> List[str]:
    ...
    def _generate_recommendations_section(
        self, review: ComprehensiveReview, format_type: str, options: Dict[str, Any]
    ) -> List[str]:
    ...
    def _generate_risk_mitigation_section(
        self, review: ComprehensiveReview, session: ReviewSession, format_type: str
    ) -> List[str]:
                    ...
                    all_risks.append(
                        {
                            ...
                            "risks": (
                                report.risk_assessment[:300] + "..."
                                if len(report.risk_assessment) > 300
